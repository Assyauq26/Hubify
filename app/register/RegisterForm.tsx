  ...
  return (
    <form action={formAction} className="space-y-5">
      ...
      <label className="block text-sm font-medium">
        ...
        <span className="mt-1.5 block text-xs text-[var(--muted-foreground)]">Use at least 6 characters.</span>
      </label>
      ...
      <p className="pt-2 text-center text-sm text-[var(--muted-foreground)]">
        ...
        <Link href="/login" className="font-medium text-[var(--foreground)] hover:underline">Sign in</Link>
      </p>
    </form>
  )
}
